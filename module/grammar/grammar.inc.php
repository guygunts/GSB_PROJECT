...
//            PrintR($responsesub);
            if ($responsesub['result'][0]['code'] == 200) {
                ...
                foreach ((array)$datasub as $z => $itemsub) {
                    ...
                    if ($permiss[3]) {
                        $btnsub .= '<button data-code="' . $itemsub['sub_intent_id'] . '" onclick="me.DelSub(this)"  type="button" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i> ' . $permiss[3]['name'] . '</button>';
                    }
...
//            $btn .= '<button data-code="' . $item['sentence_id'] . '" data-item=' . "'" . json_encode($dataattr[$i], JSON_HEX_APOS) . "'" . ' onclick="me.LoadSub(this)" type="button" class="btn btn-xs btn-success"><i class="fa fa-save"></i> ' . $permiss[2]['name'] . '</button>&nbsp;&nbsp;';
            ...
            if ($permiss[3]) {
                $btn .= '<button data-code="' . $item['sentence_id'] . '" data-item=' . "'" . json_encode($dataattr[$i], JSON_HEX_APOS) . "'" . ' onclick="me.DelSentent(this)"  type="button" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i> ' . $permiss[3]['name'] . '</button>';
            }
