...
//                    $datalist[$i][$value['data']] = '<a href="javascript:void(0)" onclick="me.OpenCHNN(' . "'" . $item['chnn'] . "'," . $data['page_id'] . ',' . $data['page_size'] . ",'" . $data['start_date'] . "','" . $data['end_date'] . "'" . ')"><i class="glyphicon glyphicon-volume-up"></i></a>';
                    ...
                    $datalist[$i][$value['data']] = '<select name="'.$value['data'].'" class="form-control action'. $item['rec_id'].' row'.$item['rec_id'].' empty'.$item['rec_id'].' "><option value="0" ' . ($item[$value['data']] == '0' ? 'selected' : '') . '>None</option><option value="1" ' . ($item[$value['data']] == '1' ? 'selected' : '') . '>Train</option><option value="2" ' . ($item[$value['data']] == '2' ? 'selected' : '') . '>Test</option><option value="1" ' . ($item[$value['data']] == '3' ? 'selected' : '') . '>Test&Train</option></select>';
